...
setpath( ["d61SugStreet"]; {
  "input": ((.numberFirst|d61num) + (.numberLast|d61numLast) + " " + .street.name + " " + .street.typeCode + (.street.suffixName|d61get|d61space)),
  "payload" : { "addressDetailPid": .addressDetailPid, "localityName": .localityName, "stateAbbreviation": .stateAbbreviation, "postcode": .postcode }
} )
